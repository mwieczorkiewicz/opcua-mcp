...
- [ ] **Step 1 — Extend `opcuaClient` interface**: add
...
- [ ] **Step 2 — `Client` extensions**: in `client.go`, add:
...
- [ ] **Step 3 — Seam interfaces**: create `internal/opcua/subscription.go`
...
- [ ] **Step 4 — `ReconnectWatcher`**: create
...
- [ ] **Step 5 — `SubscriptionManager` core**: continue
...
- [ ] **Step 9 — `ReconnectWatcher` unit tests**: create
...
- [ ] **Step 10 — `SubscriptionManager` unit tests**: create
...
- [ ] **Step 11 — Stateful property-based test**: create
...
- [ ] **Step 12 — Documentation summary**: create
